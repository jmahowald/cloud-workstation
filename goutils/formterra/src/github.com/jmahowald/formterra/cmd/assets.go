...
func templatesS3Tf() (*asset, error) {
	bytes, err := templatesS3TfBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "templates/s3.tf", size: 899, mode: os.FileMode(420), modTime: time.Unix(1472226251, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"templates": &bintree{nil, map[string]*bintree{
		"s3.tf": &bintree{templatesS3Tf, map[string]*bintree{}},
	}},
}}
